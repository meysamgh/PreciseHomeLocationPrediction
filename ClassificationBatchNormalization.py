...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 23:39:14 2019
...
print(model.summary())
model.fit(x_train, y_binary, epochs=15, batch_size=batchsize*2, shuffle=False)
...
print("DONE")
with open('outpurcategorical.csv', 'w') as csvfile:
    csvwriter=csv.writer(csvfile, delimiter=',')
    csvwriter.writerow(["PredNo", "PredY"])
    for k in range (0,len(y3)):
        tmp=y3[k]
        csvwriter.writerow([tmp[0],tmp[1]])
